...
![](/.data/using/using-gaea/managing-graphs/visualizing-scale/using-overlays.webp)
...
![](/.data/using/using-gaea/managing-graphs/visualizing-scale/creating-a-custom-overlay.webp)
...
![](/.data/using/using-gaea/managing-graphs/visualizing-scale/creating-a-custom-overlay-02.webp)
...
![](/.data/using/using-gaea/managing-graphs/visualizing-scale/creating-overlays-in-gaea.webp)
...
![](/.data/using/using-gaea/managing-graphs/visualizing-scale/creating-overlays-in-gaea-02.webp)
...
![](/.data/using/using-gaea/managing-graphs/visualizing-scale/creating-overlays-in-gaea-03.webp)
...
![](/.data/using/using-gaea/managing-graphs/visualizing-scale/creating-a-3-d-scale-dummy-02.webp)
...
<div>![](/.data/using/using-gaea/managing-graphs/visualizing-scale/creating-a-3-d-scale-dummy-03.webp) ![](/.data/using/using-gaea/managing-graphs/visualizing-scale/creating-a-3-d-scale-dummy-05.webp)</div>

Now you have this scale block.

![](/.data/using/using-gaea/managing-graphs/visualizing-scale/creating-a-3-d-scale-dummy-04.webp)

If you want to view it on your terrain, create a Combine node to Add this block on top of your terrain.

![](/.data/using/using-gaea/managing-graphs/visualizing-scale/creating-a-3-d-scale-dummy.webp)
...
![Setup a Route node to conveniently hide the block when not needed.](/.data/shared/common/what-are-nodes.webp)

You can use the Route node's toggle to quickly show and hide the version with the Block.

![Route toggled on.](/.data/using/using-gaea/managing-graphs/visualizing-scale/route-toggled-on.webp) ![Route toggled off.](/.data/using/using-gaea/managing-graphs/visualizing-scale/route-toggled-on-02.webp)
...
![](/.data/using/using-gaea/managing-graphs/visualizing-scale/creating-a-custom-reference-object.webp)
