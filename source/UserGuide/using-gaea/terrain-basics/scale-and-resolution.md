...
:::info
For detailed technical information, see [dimensions-and-scale.md](../../advanced-topics/technical-information/dimensions-and-scale.html) in [Broken link](broken-reference "mention").
:::
