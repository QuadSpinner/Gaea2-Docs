...
Both Landscapes and Primitives will have some level of natural processing built-in, such as Erosion, and will mostly have the option to turn it off as well. However, these are meant only as a starting point. You will need to add proper [erosion](erosion.html) and possibly other [surface-nodes](surface-nodes.html) to turn it into a more realistic environment.
