...
![Setup a Route node to conveniently hide the block when not needed.](/.data/assets/image (12).png)

You can use the Route node's toggle to quickly show and hide the version with the Block.

<div>![Route toggled on.](/.data/assets/image (13).png) ![Route toggled off.](/.data/assets/image (14).png)</div>
