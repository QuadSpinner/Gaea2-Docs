...
:::info
For automation scenarios where you wish to explicitly name the output file, see [managing-input-and-output.md](../../advanced-topics/automation/managing-input-and-output.html) in [automation](../../advanced-topics/automation/ "mention")
:::
