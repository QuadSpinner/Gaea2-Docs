...
<figure><img src="/.data/assets/suspend_engine.png"><figcaption><p>When the engine is suspended, an animated red line appears around the Graph. The progress status icon (bottom left) and the Suspend Engine button in the Graph Toolbar (right) also turn red.</p></figcaption></figure>
