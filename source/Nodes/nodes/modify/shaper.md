...
:::info
Shaper is a very useful tool that is fast and effective. You can use it through the [adjust.md](adjust.html) node as well as the [Modifier Stack](https://app.gitbook.com/s/-MRH8eXs83d5sUGKdsHp/getting-started/user-interface/property-editor/modifier-stack "mention"). However, the Shaper node is the only way to use the advanced options.
:::
