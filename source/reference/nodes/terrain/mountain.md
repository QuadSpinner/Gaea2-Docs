...
![](/.data/reference/nodes/terrain/mountain/mountain.webp)
...
## When to Use It
Use Mountain when you need a fast large-scale landform that can anchor the rest of the terrain graph.

## Visual Direction

![](/.data/reference/nodes/terrain/mountain/visual-direction.webp)
