...
uid: reference-home
description: Browse the Gaea reference section, including node documentation, node maps, and bridge-specific reference pages.
---
...
If you are learning how to build terrains, start in @home-user-guide first. If you already know the node, category, or output you are looking for, this is the faster place to work from.
...
Use @gaea2houdini-nodes when you need reference material for Gaea nodes exposed through the Houdini bridge.
