...
## GeoTIFF DEM (common GIS export: 16-bit int, 32-bit float)
...
## 16-bit PNG (very common “heightmap” interchange)
...
## 16-bit TIFF (popular in DCC/VFX pipelines)
...
## 32-bit EXR (best general-purpose “height as data” format)
...
## RAW / R16 / .raw (engine-friendly, but easy to mess up)
...
## 8-bit formats (PNG/JPG) — only for masks, never for heights
