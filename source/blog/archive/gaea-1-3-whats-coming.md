...
Originally, Tiled Builds, Mesh Importer, and Rivers were supposed to be the pillars of Gaea 1.3. However, based on your input and our own evaluation of the software as a whole, stability and performance became the main focus. The other features were re-arranged around that.

![](__GHOST_URL__/content/images/2022/02/QuadSpinner_Gaea_-Dev-_-1.3.0-_-crat.tor-_02-11-08-AM.jpg)We are happy to say that Gaea 1.3 is the most performant version to date. Your consistent feedback through the Bleeding Edge builds confirms that performance has significantly improved across the software.
...
![](__GHOST_URL__/content/images/2022/02/QuadSpinner_Gaea_-Dev-_-1.3.0-_-riversLakes-001.to_01-56-54-AM.jpg)While Tiled Builds are important, not everyone needs that component. Releasing 1.3 now without those few standalone features will benefit a large portion of the user base.
...
💡If you haven't tried the *Bleeding Edge*, head over to [the download page](https://quadspinner.com/download/). It is forward compatible with the Production Ready build.
